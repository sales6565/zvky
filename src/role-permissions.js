...
function defaultsFor(roleKey) {
  ...
  if (TL_REVIEW_GROUPS.includes(def.group)) {
    ...
    /* And their team's timesheets, to read. The same question again — who is a
       lead — so the same answer.
       
       Reading is all there is: timesheet.approve used to start here too, and
       the studio removed the step it gated. Seeing your team's hours is
       oversight; there is nothing left to sign off. */
