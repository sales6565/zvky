...
const REQUIRED = [
  ...
  { table: 'assets',         column: 'start_date',     step: 'asset brief and checklist' },
  ...
  { table: 'work_schedule',    column: 'evening_start_min', step: 'break windows' },
  ...
  { table: 'activity_log',     column: null,            step: 'activity log' },
  { table: 'asset_thumbnails', column: null,            step: 'asset thumbnails' },
  { table: 'asset_thumbnails', column: 'source_url',   step: 'asset thumbnails' },
